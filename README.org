...
(use-package emacs
  ...
  (custom-file "~/.config/emacs/ignoreme.el")
...
If file is not in a git repo or file is not a real file (aka buffer), then do nothing."
  ...
  (defun gopar/add-env-vars ()
    ...
    (load-file "~/.config/emacs/etc/eshell/set_env.el")
...
(use-package org
  ...
  (org-archive-location (concat (expand-file-name "~/Dropbox/Documents/notes/archives.org") "::"))
  ...
  (org-refile-targets '(("~/Dropbox/Documents/notes/gtd.org" :maxlevel . 3)
                        ("~/Dropbox/Documents/notes/someday.org" :level . 1)
                        ("~/DropboxDocuments/notes/tickler.org" :maxlevel . 1)
                        ("~/Dropbox/Documents/notes/repeat.org" :maxlevel . 1)
                        ))
...
(use-package org-agenda
  ...
  (org-agenda-files "~/Dropbox/Documents/notes/agenda-files.org")
   ...
   '(("h" "Agenda and Home tasks"
     ...
     ("r" "Weekly Review"
      ...
      ((org-agenda-sorting-strategy '(time-up habit-up category-up priority-down ))
       (org-agenda-files "~/Dropbox/Documents/notes/weekly-reivew-agenda-files.org")
...
(use-package org-capture
  ...
  (org-capture-templates
   '(
     ("c" "Inbox" entry (file "~/Dropbox/Documents/notes/inbox.org")
      "* TODO %?\n:PROPERTIES:\n:DATE_ADDED: %u\n:END:")
     ("p" "Project" entry (file "~/Dropbox/Documents/notes/gtd.org")
      "* %? [%] :project: \n:PROPERTIES: \n:TRIGGER: next-sibling todo!(NEXT) scheduled!(copy)\n:ORDERED: t \n:DATE_ADDED: %u\n:END:\n** TODO Add entry")
     ("t" "Tickler" entry (file "~/Dropbox/Documents/notes/tickler.org")
      "* TODO %? \nSCHEDULED: %^{Schedule}t\n:PROPERTIES:\n:DATE_ADDED: %u\n:END:\n")
     ("k" "Contact" entry (file "~/Dropbox/Documents/notes/contacts.org")
      "* %? \n%U
:PROPERTIES:
:EMAIL:
:PHONE:
...
(use-package org-roam
  ...
  :defer
  :custom
  (org-roam-directory (expand-file-name "~/Dropbox/Documents/notes/org-roam"))
  (org-roam-db-location (expand-file-name "~/Dropbox/Documents/notes/org-roam.db"))
  (org-roam-capture-templates
   '(("d" "default" plain "%?"
      :target (file+head "./references/${slug}.org" "#+title: ${title}\n")
      :unnarrowed t)))
  (org-roam-dailies-directory (expand-file-name "~/Dropbox/Documents/journal/"))
...
(use-package dumb-jump
  ...
  (dumb-jump-default-project "~/Dropbox/projects/work")
  :init
...
(use-package super-hint
  :load-path "~/.config/emacs/tmp/super-hint.el/"
...
* Emacs Dashboard-Only Startup (Vanilla Emacs)

To ensure Emacs starts with only the Dashboard buffer visible (no extra windows or buffers):

#+begin_src emacs-lisp
;; Suppress splash screen and scratch buffer
;; (setq inhibit-startup-screen t)
;; (setq initial-scratch-message nil)
;; (setq initial-buffer-choice (lambda () (get-buffer "*dashboard*")))

;; ;; Prevent treemacs from auto-launching
;; (with-eval-after-load 'treemacs
;;   (remove-hook 'emacs-startup-hook #'treemacs))

;; ;; Optional: disable treemacs auto-follow
;; (setq treemacs-follow-mode nil)

;; ;; On startup, kill all other windows and show only Dashboard
...
#+begin_src emacs-lisp
(with-no-warnings
  ;; some package config that triggers the obsolete var warning
  )
#+end_src
From Prot
